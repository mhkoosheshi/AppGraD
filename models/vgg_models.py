...
def vgg16_s2d(n_freeze=10,
  ...
  x1 = vgg.layers[1](x0)
  x1 = vgg.layers[2](x1)
  s2d1 = Lambda(lambda x:tf.nn.space_to_depth(x,2))
  x2 = s2d1(x1)
  x2 = vgg.layers[4](x2)
  x2 = vgg.layers[5](x2)
  s2d2 = Lambda(lambda x:tf.nn.space_to_depth(x,2))
  x3 = s2d2(x2)
  x3 = vgg.layers[7](x3)
  x3 = vgg.layers[8](x3)
  x3 = vgg.layers[9](x3)
  s2d3 = Lambda(lambda x:tf.nn.space_to_depth(x,2))
  x4 = s2d3(x3)
  x4 = vgg.layers[11](x4)
  x4 = vgg.layers[12](x4)
  x4 = vgg.layers[13](x4)
  s2d4 = Lambda(lambda x:tf.nn.space_to_depth(x,2))
  x5 = s2d4(x4)
  x5 = vgg.layers[15](x5)
  x5 = vgg.layers[16](x5)
  x5 = vgg.layers[17](x5)
  s2d5 = Lambda(lambda x:tf.nn.space_to_depth(x,2))
  x6 = s2d5(x5)

  vgg_s2d = tf.keras.Model(inputs=x0, outputs=x6)
